...
class ColorOverLifetimeModule extends ParticleModule {
    ...
    updateParticle(particle, dt) {
        ...
        const sampled = this.evaluateGradient(t);
        particle.color = [
            sampled[0] * particle.startColor[0],
            sampled[1] * particle.startColor[1],
            sampled[2] * particle.startColor[2],
            sampled[3] * particle.startColor[3]
        ];
    }
